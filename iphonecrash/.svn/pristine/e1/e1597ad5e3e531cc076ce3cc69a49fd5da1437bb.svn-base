...
#ifndef VoteCloudMacro_h
#define VoteCloudMacro_h
...
// 主题颜色
#define  ThemeColor ([UIColor colorWithHexString:@"#FF9C10"])
...
#define U_TOKEN   [[NSUserDefaults standardUserDefaults] objectForKey:@"utoken"]
