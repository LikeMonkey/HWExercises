...
#import "CommonFunc.h"
//上传图片最大长度 如果压缩图片就会压缩到接近于 img_max_size 字节 60kb
#define img_max_size 60000

#define AppendAPI(host,api) [[host stringByAppendingString:api]stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]

#define Token_key @"R43B4JU6"
